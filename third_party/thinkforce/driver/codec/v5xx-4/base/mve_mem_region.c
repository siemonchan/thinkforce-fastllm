...
static const struct mve_mem_virt_region *get_mem_virt_regions(void)
{
    ...
    {
        return mve_com_hi_v3_get_mem_virt_region4();
    }
    else
    {
        return mve_com_hi_v2_get_mem_virt_region4();
    }

    return NULL;
}

void mve_mem_virt_region_get4(enum mve_mem_virt_region_type type,
...
enum mve_mem_virt_region_type mve_mem_virt_region_type_get4(mve_addr_t mve_addr)
{
