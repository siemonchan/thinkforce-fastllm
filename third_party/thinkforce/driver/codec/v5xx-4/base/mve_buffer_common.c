...
{
    {   /* Valloc */
        .create_buffer_external  = mve_buffer_valloc_create_buffer_external4,
        .destroy_buffer_external = mve_buffer_valloc_destroy_buffer_external4,
        .map_physical_pages      = mve_buffer_valloc_map_physical_pages4,
        .unmap_physical_pages    = mve_buffer_valloc_unmap_physical_pages4,
        .set_owner               = mve_buffer_valloc_set_owner4
    },
    {   /* Attachment */
        .create_buffer_external  = mve_buffer_attachment_create_buffer_external4,
        .destroy_buffer_external = mve_buffer_attachment_destroy_buffer_external4,
        .map_physical_pages      = mve_buffer_attachment_map_physical_pages4,
        .unmap_physical_pages    = mve_buffer_attachment_unmap_physical_pages4,
        .set_owner               = mve_buffer_attachment_set_owner4
    },
#ifndef EMULATOR
    {   /* dma buf */
        .create_buffer_external  = mve_buffer_dmabuf_create_buffer_external4,
        .destroy_buffer_external = mve_buffer_dmabuf_destroy_buffer_external4,
        .map_physical_pages      = mve_buffer_dmabuf_map_physical_pages4,
        .unmap_physical_pages    = mve_buffer_dmabuf_unmap_physical_pages4,
        .set_owner               = mve_buffer_dmabuf_set_owner4
    },
    {   /* ashmem buf */
        .create_buffer_external  = mve_buffer_ashmem_create_buffer_external4,
        .destroy_buffer_external = mve_buffer_ashmem_destroy_buffer_external4,
        .map_physical_pages      = mve_buffer_ashmem_map_physical_pages4,
        .unmap_physical_pages    = mve_buffer_ashmem_unmap_physical_pages4,
        .set_owner               = mve_buffer_ashmem_set_owner4
    }
#endif
};
