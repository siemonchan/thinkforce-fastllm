...
struct mve_buffer_external *mve_buffer_dmabuf_create_buffer_external4(struct mve_buffer_info *info)
{
    ...
    buffer_external->attachment = dma_buf_attach(buffer_external->handle, &mve_rsrc_data4.pdev->dev);
...
void mve_buffer_dmabuf_destroy_buffer_external4(struct mve_buffer_external *buffer)
{
...
bool mve_buffer_dmabuf_map_physical_pages4(struct mve_buffer_external *buffer)
{
    struct dmabuf_buffer_external *buffer_external;
...
bool mve_buffer_dmabuf_unmap_physical_pages4(struct mve_buffer_external *buffer)
{
    struct dmabuf_buffer_external *buffer_external;
...
void mve_buffer_dmabuf_set_owner4(struct mve_buffer_external *buffer,
                                 ...
                                 enum mve_port_index port)
{
    ...
    sync_func(&mve_rsrc_data4.pdev->dev, buffer_external->sg->sgl, buffer_external->sg->nents, direction);
}
