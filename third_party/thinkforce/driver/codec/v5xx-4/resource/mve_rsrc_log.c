...
struct mve_rsrc_log_group mve_rsrc_log4;
struct mve_rsrc_log_group mve_rsrc_log_scheduler4;
struct mve_rsrc_log_group mve_rsrc_log_fwif4;
struct mve_rsrc_log_group mve_rsrc_log_session4;

EXPORT_SYMBOL(mve_rsrc_log4);
EXPORT_SYMBOL(mve_rsrc_log_fwif4);
EXPORT_SYMBOL(mve_rsrc_log_session4);
...
void mve_rsrc_log_init4(void)
{
    ...
    mve_rsrc_log_group_construct(&mve_rsrc_log4, "MVE", MVE_LOG_WARNING, drain_default);
    mve_rsrc_log_group_add(&log, "generic", &mve_rsrc_log4);

    mve_rsrc_log_group_construct(&mve_rsrc_log_scheduler4, "MVE scheduler", MVE_LOG_WARNING, drain_default);
    mve_rsrc_log_group_add(&log, "scheduler", &mve_rsrc_log_scheduler4);

    mve_rsrc_log_group_construct(&mve_rsrc_log_fwif4, "MVE fwif", MVE_LOG_INFO, drain_ram);
    mve_rsrc_log_group_add(&log, "firmware_interface", &mve_rsrc_log_fwif4);

    mve_rsrc_log_group_construct(&mve_rsrc_log_session4, "MVE session", MVE_LOG_WARNING, drain_default);
    mve_rsrc_log_group_add(&log, "session", &mve_rsrc_log_session4);
}

void mve_rsrc_log_destroy4(void)
{
    /* Destroy objects in reverse order. */
    mve_rsrc_log_destruct(&log);

    mve_rsrc_log_group_destruct(&mve_rsrc_log4);
    mve_rsrc_log_group_destruct(&mve_rsrc_log_scheduler4);
    mve_rsrc_log_group_destruct(&mve_rsrc_log_fwif4);
    mve_rsrc_log_group_destruct(&mve_rsrc_log_session4);
...
const char *mve_rsrc_log_strrchr4(const char *s)
{
...
struct dentry *mve_rsrc_log_get_parent_dir4(void)
{
    return log.mve_dir;
}

EXPORT_SYMBOL(mve_rsrc_log_strrchr4);
EXPORT_SYMBOL(mve_rsrc_log_get_parent_dir4);
