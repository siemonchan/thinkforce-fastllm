...
#define __MVE_LOG_PRINT(_lg, _severity, _fmt, ...)           \
    (_lg)->drain->print((_lg)->drain, _severity, (_lg)->tag, \
                        ...
                        ##__VA_ARGS__,                       \
                        mve_rsrc_log_strrchr4(__FILE__), __LINE__)
#else
#define __MVE_LOG_PRINT(_lg, _severity, _fmt, ...)                 \
...
extern struct mve_rsrc_log_group mve_rsrc_log4;
extern struct mve_rsrc_log_group mve_rsrc_log_scheduler4;
extern struct mve_rsrc_log_group mve_rsrc_log_fwif4;
extern struct mve_rsrc_log_group mve_rsrc_log_session4;
