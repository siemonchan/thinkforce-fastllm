...
struct mver_circular_buffer *mver_circular_buffer_create4(int size)
{
...
void mver_circular_buffer_destroy4(struct mver_circular_buffer *cb)
{
    if (NULL != cb)
    {
...
static bool has_free_element(struct mver_circular_buffer *cb)
{
    ...
    return mver_circular_buffer_get_num_entries4(cb) < cb->size - 1;
}

bool mver_circular_buffer_add4(struct mver_circular_buffer *cb, void *item)
{
    bool ret = false;
...
bool mver_circular_buffer_remove4(struct mver_circular_buffer *cb, void **data)
{
    bool ret = false;

    if (mver_circular_buffer_get_num_entries4(cb) > 0)
    {
...
int mver_circular_buffer_get_num_entries4(struct mver_circular_buffer *cb)
{
    int num = 0;
...
bool mver_circular_buffer_peek4(struct mver_circular_buffer *cb, void **data)
{
    bool ret = false;
...
void mver_circular_buffer_remove_all_occurences4(struct mver_circular_buffer *cb, void *data)
{
    int curr;
