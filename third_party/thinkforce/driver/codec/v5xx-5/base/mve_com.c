                                   ...
                                   uint32_t *data)
{
    ...
    {
        MVE_LOG_PRINT(&mve_rsrc_log_fwif5, MVE_LOG_ERROR, "%p mve_com_add_message() returned error status. ret=%u, code=%u, size=%u.", session, ret, code, size);
    }
                                        ...
                                        enum mve_com_buffer_type type)
{
    ...
    {
        MVE_LOG_PRINT(&mve_rsrc_log_fwif5, MVE_LOG_ERROR, "%p mve_com_add_input_buffer5() returned error status. ret=%u.", session, res);
    }
                                         ...
                                         enum mve_com_buffer_type type)
{
    ...
    {
        MVE_LOG_PRINT(&mve_rsrc_log_fwif5, MVE_LOG_ERROR, "%p mve_com_add_output_buffer5() returned error status. ret=%u.", session, res);
    }
                                        ...
                                        mve_com_buffer *buffer)
{
    ...
    {
        MVE_LOG_PRINT(&mve_rsrc_log_fwif5, MVE_LOG_ERROR, "%p mve_com_get_input_buffer5() returned error status. ret=%u.", session, ret);
    }
                                         ...
                                         mve_com_buffer *buffer)
{
    ...
    {
        MVE_LOG_PRINT(&mve_rsrc_log_fwif5, MVE_LOG_ERROR, "%p mve_com_get_output_buffer5() returned error status. ret=%u.", session, ret);
    }
                                             ...
                                             enum mve_base_fw_major_prot_ver version)
{
    ...
    switch (version)
    {
        ...
        {
            session->com = mve_com_host_interface_v2_new5();
            break;
        }

        case MVE_BASE_FW_MAJOR_PROT_V3:
        {
            session->com = mve_com_host_interface_v3_new5();
            break;
        }

        default:
        {
            MVE_LOG_PRINT(&mve_rsrc_log_fwif5, MVE_LOG_ERROR, "%p unsupported interface version configured. version=%u.", session, version);
            return MVE_BASE_ERROR_BAD_PARAMETER;
        }
    }
