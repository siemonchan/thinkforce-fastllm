...
struct mve_com *mve_com_host_interface_v3_new5(void)
{
    struct mve_com *com = mve_com_host_interface_v2_new5();
    if (NULL != com)
    {
...
const struct mve_mem_virt_region *mve_com_hi_v3_get_mem_virt_region5(void)
{
    return mem_regions;
}
