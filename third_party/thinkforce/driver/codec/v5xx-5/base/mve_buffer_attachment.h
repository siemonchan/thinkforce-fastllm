 ...
 */
struct mve_buffer_external *mve_buffer_attachment_create_buffer_external5(struct mve_buffer_info *info);
 ...
 */
void mve_buffer_attachment_destroy_buffer_external5(struct mve_buffer_external *buffer);
 ...
 */
bool mve_buffer_attachment_map_physical_pages5(struct mve_buffer_external *buffer);
 ...
 * @return Always returns true
 */
bool mve_buffer_attachment_unmap_physical_pages5(struct mve_buffer_external *buffer);

/**
 * This function doesn't do anything for attachment buffers.
 */
void mve_buffer_attachment_set_owner5(struct mve_buffer_external *buffer,
