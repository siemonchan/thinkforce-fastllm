...
#define __MVE_LOG_PRINT(_lg, _severity, _fmt, ...)           \
    (_lg)->drain->print((_lg)->drain, _severity, (_lg)->tag, \
                        ...
                        ##__VA_ARGS__,                       \
                        mve_rsrc_log_strrchr5(__FILE__), __LINE__)
#else
#define __MVE_LOG_PRINT(_lg, _severity, _fmt, ...)                 \
...
extern struct mve_rsrc_log_group mve_rsrc_log5;
extern struct mve_rsrc_log_group mve_rsrc_log_scheduler5;
extern struct mve_rsrc_log_group mve_rsrc_log_fwif5;
extern struct mve_rsrc_log_group mve_rsrc_log_session5;
