...
struct mve_rsrc_log_group mve_rsrc_log5;
struct mve_rsrc_log_group mve_rsrc_log_scheduler5;
struct mve_rsrc_log_group mve_rsrc_log_fwif5;
struct mve_rsrc_log_group mve_rsrc_log_session5;

EXPORT_SYMBOL(mve_rsrc_log5);
EXPORT_SYMBOL(mve_rsrc_log_fwif5);
EXPORT_SYMBOL(mve_rsrc_log_session5);
...
void mve_rsrc_log_init5(void)
{
    ...
    mve_rsrc_log_group_construct(&mve_rsrc_log5, "MVE", MVE_LOG_WARNING, drain_default);
    mve_rsrc_log_group_add(&log, "generic", &mve_rsrc_log5);

    mve_rsrc_log_group_construct(&mve_rsrc_log_scheduler5, "MVE scheduler", MVE_LOG_WARNING, drain_default);
    mve_rsrc_log_group_add(&log, "scheduler", &mve_rsrc_log_scheduler5);

    mve_rsrc_log_group_construct(&mve_rsrc_log_fwif5, "MVE fwif", MVE_LOG_INFO, drain_ram);
    mve_rsrc_log_group_add(&log, "firmware_interface", &mve_rsrc_log_fwif5);

    mve_rsrc_log_group_construct(&mve_rsrc_log_session5, "MVE session", MVE_LOG_WARNING, drain_default);
    mve_rsrc_log_group_add(&log, "session", &mve_rsrc_log_session5);
}

void mve_rsrc_log_destroy5(void)
{
    /* Destroy objects in reverse order. */
    mve_rsrc_log_destruct(&log);

    mve_rsrc_log_group_destruct(&mve_rsrc_log5);
    mve_rsrc_log_group_destruct(&mve_rsrc_log_scheduler5);
    mve_rsrc_log_group_destruct(&mve_rsrc_log_fwif5);
    mve_rsrc_log_group_destruct(&mve_rsrc_log_session5);
...
const char *mve_rsrc_log_strrchr5(const char *s)
{
...
struct dentry *mve_rsrc_log_get_parent_dir5(void)
{
    return log.mve_dir;
}

EXPORT_SYMBOL(mve_rsrc_log_strrchr5);
EXPORT_SYMBOL(mve_rsrc_log_get_parent_dir5);
