...
{
    {   /* Valloc */
        .create_buffer_external  = mve_buffer_valloc_create_buffer_external2,
        .destroy_buffer_external = mve_buffer_valloc_destroy_buffer_external2,
        .map_physical_pages      = mve_buffer_valloc_map_physical_pages2,
        .unmap_physical_pages    = mve_buffer_valloc_unmap_physical_pages2,
        .set_owner               = mve_buffer_valloc_set_owner2
    },
    {   /* Attachment */
        .create_buffer_external  = mve_buffer_attachment_create_buffer_external2,
        .destroy_buffer_external = mve_buffer_attachment_destroy_buffer_external2,
        .map_physical_pages      = mve_buffer_attachment_map_physical_pages2,
        .unmap_physical_pages    = mve_buffer_attachment_unmap_physical_pages2,
        .set_owner               = mve_buffer_attachment_set_owner2
    },
#ifndef EMULATOR
    {   /* dma buf */
        .create_buffer_external  = mve_buffer_dmabuf_create_buffer_external2,
        .destroy_buffer_external = mve_buffer_dmabuf_destroy_buffer_external2,
        .map_physical_pages      = mve_buffer_dmabuf_map_physical_pages2,
        .unmap_physical_pages    = mve_buffer_dmabuf_unmap_physical_pages2,
        .set_owner               = mve_buffer_dmabuf_set_owner2
    },
    {   /* ashmem buf */
        .create_buffer_external  = mve_buffer_ashmem_create_buffer_external2,
        .destroy_buffer_external = mve_buffer_ashmem_destroy_buffer_external2,
        .map_physical_pages      = mve_buffer_ashmem_map_physical_pages2,
        .unmap_physical_pages    = mve_buffer_ashmem_unmap_physical_pages2,
        .set_owner               = mve_buffer_ashmem_set_owner2
    }
#endif
};

bool mve_buffer_is_valid2(const struct mve_buffer_info *info)
{
    int bpp, size;
...
struct mve_buffer_external *mve_buffer_create_buffer_external2(struct mve_buffer_info *info, uint32_t port)
{
...
void mve_buffer_destroy_buffer_external2(struct mve_buffer_external *buffer)
{
    allocators[buffer->info.allocator].destroy_buffer_external(buffer);
}

bool mve_buffer_map_physical_pages2(struct mve_buffer_external *buffer)
{
    return allocators[buffer->info.allocator].map_physical_pages(buffer);
}

bool mve_buffer_unmap_physical_pages2(struct mve_buffer_external *buffer)
{
    return allocators[buffer->info.allocator].unmap_physical_pages(buffer);
}

void mve_buffer_set_owner2(struct mve_buffer_external *buffer,
                          enum mve_buffer_owner owner,
                          enum mve_port_index port)
{
