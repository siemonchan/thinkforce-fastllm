 ...
 */
mve_base_error mve_session_enqueue_flush_buffers2(struct mve_session *session,
                                                 uint32_t flush);
 ...
 * @return MVE error code.
 */
mve_base_error mve_session_enqueue_state_change2(struct mve_session *session,
...
void *mve_session_get_static_fptr2(char *func_name);
