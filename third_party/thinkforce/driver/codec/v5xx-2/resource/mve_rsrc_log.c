...
struct mve_rsrc_log_group mve_rsrc_log2;
struct mve_rsrc_log_group mve_rsrc_log_scheduler2;
struct mve_rsrc_log_group mve_rsrc_log_fwif2;
struct mve_rsrc_log_group mve_rsrc_log_session2;

EXPORT_SYMBOL(mve_rsrc_log2);
EXPORT_SYMBOL(mve_rsrc_log_fwif2);
EXPORT_SYMBOL(mve_rsrc_log_session2);
...
void mve_rsrc_log_init2(void)
{
    ...
    mve_rsrc_log_group_construct(&mve_rsrc_log2, "MVE", MVE_LOG_WARNING, drain_default);
    mve_rsrc_log_group_add(&log, "generic", &mve_rsrc_log2);

    mve_rsrc_log_group_construct(&mve_rsrc_log_scheduler2, "MVE scheduler", MVE_LOG_WARNING, drain_default);
    mve_rsrc_log_group_add(&log, "scheduler", &mve_rsrc_log_scheduler2);

    mve_rsrc_log_group_construct(&mve_rsrc_log_fwif2, "MVE fwif", MVE_LOG_INFO, drain_ram);
    mve_rsrc_log_group_add(&log, "firmware_interface", &mve_rsrc_log_fwif2);

    mve_rsrc_log_group_construct(&mve_rsrc_log_session2, "MVE session", MVE_LOG_WARNING, drain_default);
    mve_rsrc_log_group_add(&log, "session", &mve_rsrc_log_session2);
}

void mve_rsrc_log_destroy2(void)
{
    /* Destroy objects in reverse order. */
    mve_rsrc_log_destruct(&log);

    mve_rsrc_log_group_destruct(&mve_rsrc_log2);
    mve_rsrc_log_group_destruct(&mve_rsrc_log_scheduler2);
    mve_rsrc_log_group_destruct(&mve_rsrc_log_fwif2);
    mve_rsrc_log_group_destruct(&mve_rsrc_log_session2);
...
const char *mve_rsrc_log_strrchr2(const char *s)
{
...
struct dentry *mve_rsrc_log_get_parent_dir2(void)
{
    return log.mve_dir;
}

EXPORT_SYMBOL(mve_rsrc_log_strrchr2);
EXPORT_SYMBOL(mve_rsrc_log_get_parent_dir2);
