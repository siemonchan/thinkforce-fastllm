...
#define MVE_RSRC_MEM_CACHE_ALLOC(size, flags) \
    mve_rsrc_mem_zalloc_track2(size, flags, ALLOCATOR_CACHE, __FUNCTION__, __LINE__)

#define MVE_RSRC_MEM_CACHE_FREE(ptr, size) \
    mve_rsrc_mem_free_track2(ptr, size, ALLOCATOR_CACHE, __FUNCTION__, __LINE__)

#else

#define MVE_RSRC_MEM_CACHE_ALLOC(size, flags) \
    mve_rsrc_mem_zalloc_track2(size, flags, ALLOCATOR_KMALLOC, __FUNCTION__, __LINE__)

#define MVE_RSRC_MEM_CACHE_FREE(ptr, size) \
    mve_rsrc_mem_free_track2(ptr, size, ALLOCATOR_KMALLOC, __FUNCTION__, __LINE__)
...
#define MVE_RSRC_MEM_FREE(ptr) \
    mve_rsrc_mem_free_track2(ptr, 0, ALLOCATOR_KMALLOC, __FUNCTION__, __LINE__)

#define MVE_RSRC_MEM_VALLOC(size) \
    mve_rsrc_mem_zalloc_track2(size, 0, ALLOCATOR_VMALLOC, __FUNCTION__, __LINE__)

#define MVE_RSRC_MEM_VFREE(ptr) \
    mve_rsrc_mem_free_track2(ptr, 0, ALLOCATOR_VMALLOC, __FUNCTION__, __LINE__)

#define MVE_RSRC_MEM_ALLOC_PAGE() \
    mve_rsrc_mem_alloc_page_track2(__FUNCTION__, __LINE__)

#define MVE_RSRC_MEM_FREE_PAGE(paddr) \
    mve_rsrc_mem_free_page_track2(paddr, __FUNCTION__, __LINE__)

#define MVE_RSRC_MEM_ALLOC_PAGES(nr_pages) \
    mve_rsrc_mem_alloc_pages_track2(nr_pages, __FUNCTION__, __LINE__)

#define MVE_RSRC_MEM_FREE_PAGES(paddrs, nr_pages) \
    mve_rsrc_mem_free_pages_track2(paddrs, nr_pages, __FUNCTION__, __LINE__)
...
#if (LINUX_VERSION_CODE < KERNEL_VERSION(5, 15, 0))
#define MVE_RSRC_MEM_CACHE_ALLOC(size, flags) \
    mve_rsrc_mem_cache_alloc2(size, flags)
...
#define MVE_RSRC_MEM_ALLOC_PAGE() \
    mve_rsrc_mem_alloc_page2()

#define MVE_RSRC_MEM_FREE_PAGE(paddr) \
    mve_rsrc_mem_free_page2(paddr)

#define MVE_RSRC_MEM_ALLOC_PAGES(nr_pages) \
    mve_rsrc_mem_alloc_pages2(nr_pages)
