...
{
    {   /* Valloc */
        .create_buffer_external  = mve_buffer_valloc_create_buffer_external3,
        .destroy_buffer_external = mve_buffer_valloc_destroy_buffer_external3,
        .map_physical_pages      = mve_buffer_valloc_map_physical_pages3,
        .unmap_physical_pages    = mve_buffer_valloc_unmap_physical_pages3,
        .set_owner               = mve_buffer_valloc_set_owner3
    },
    {   /* Attachment */
        .create_buffer_external  = mve_buffer_attachment_create_buffer_external3,
        .destroy_buffer_external = mve_buffer_attachment_destroy_buffer_external3,
        .map_physical_pages      = mve_buffer_attachment_map_physical_pages3,
        .unmap_physical_pages    = mve_buffer_attachment_unmap_physical_pages3,
        .set_owner               = mve_buffer_attachment_set_owner3
    },
#ifndef EMULATOR
    {   /* dma buf */
        .create_buffer_external  = mve_buffer_dmabuf_create_buffer_external3,
        .destroy_buffer_external = mve_buffer_dmabuf_destroy_buffer_external3,
        .map_physical_pages      = mve_buffer_dmabuf_map_physical_pages3,
        .unmap_physical_pages    = mve_buffer_dmabuf_unmap_physical_pages3,
        .set_owner               = mve_buffer_dmabuf_set_owner3
    },
    {   /* ashmem buf */
        .create_buffer_external  = mve_buffer_ashmem_create_buffer_external3,
        .destroy_buffer_external = mve_buffer_ashmem_destroy_buffer_external3,
        .map_physical_pages      = mve_buffer_ashmem_map_physical_pages3,
        .unmap_physical_pages    = mve_buffer_ashmem_unmap_physical_pages3,
        .set_owner               = mve_buffer_ashmem_set_owner3
    }
#endif
};

bool mve_buffer_is_valid3(const struct mve_buffer_info *info)
{
    int bpp, size;
...
struct mve_buffer_external *mve_buffer_create_buffer_external3(struct mve_buffer_info *info, uint32_t port)
{
...
void mve_buffer_destroy_buffer_external3(struct mve_buffer_external *buffer)
{
    allocators[buffer->info.allocator].destroy_buffer_external(buffer);
}

bool mve_buffer_map_physical_pages3(struct mve_buffer_external *buffer)
{
    return allocators[buffer->info.allocator].map_physical_pages(buffer);
}

bool mve_buffer_unmap_physical_pages3(struct mve_buffer_external *buffer)
{
    return allocators[buffer->info.allocator].unmap_physical_pages(buffer);
}

void mve_buffer_set_owner3(struct mve_buffer_external *buffer,
                          enum mve_buffer_owner owner,
                          enum mve_port_index port)
{
