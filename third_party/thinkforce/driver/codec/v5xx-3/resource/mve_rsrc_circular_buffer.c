...
struct mver_circular_buffer *mver_circular_buffer_create3(int size)
{
...
void mver_circular_buffer_destroy3(struct mver_circular_buffer *cb)
{
    if (NULL != cb)
    {
...
static bool has_free_element(struct mver_circular_buffer *cb)
{
    ...
    return mver_circular_buffer_get_num_entries3(cb) < cb->size - 1;
}

bool mver_circular_buffer_add3(struct mver_circular_buffer *cb, void *item)
{
    bool ret = false;
...
bool mver_circular_buffer_remove3(struct mver_circular_buffer *cb, void **data)
{
    bool ret = false;

    if (mver_circular_buffer_get_num_entries3(cb) > 0)
    {
...
int mver_circular_buffer_get_num_entries3(struct mver_circular_buffer *cb)
{
    int num = 0;
...
bool mver_circular_buffer_peek3(struct mver_circular_buffer *cb, void **data)
{
    bool ret = false;
...
void mver_circular_buffer_remove_all_occurences3(struct mver_circular_buffer *cb, void *data)
{
    int curr;
