...
struct mve_buffer_external *mve_buffer_valloc_create_buffer_external6(struct mve_buffer_info *info)
{
...
void mve_buffer_valloc_destroy_buffer_external6(struct mve_buffer_external *buffer)
{
    MVE_RSRC_MEM_CACHE_FREE(buffer, sizeof(struct mve_buffer_external));
}

bool mve_buffer_valloc_map_physical_pages6(struct mve_buffer_external *buffer)
{
    uint32_t size;
    void *ptr;
    uint32_t num_pages;
...
bool mve_buffer_valloc_unmap_physical_pages6(struct mve_buffer_external *buffer)
{
...
void mve_buffer_valloc_set_owner6(struct mve_buffer_external *buffer,
