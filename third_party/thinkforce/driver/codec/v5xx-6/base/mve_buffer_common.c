...
{
    {   /* Valloc */
        .create_buffer_external  = mve_buffer_valloc_create_buffer_external6,
        .destroy_buffer_external = mve_buffer_valloc_destroy_buffer_external6,
        .map_physical_pages      = mve_buffer_valloc_map_physical_pages6,
        .unmap_physical_pages    = mve_buffer_valloc_unmap_physical_pages6,
        .set_owner               = mve_buffer_valloc_set_owner6
    },
    {   /* Attachment */
        .create_buffer_external  = mve_buffer_attachment_create_buffer_external6,
        .destroy_buffer_external = mve_buffer_attachment_destroy_buffer_external6,
        .map_physical_pages      = mve_buffer_attachment_map_physical_pages6,
        .unmap_physical_pages    = mve_buffer_attachment_unmap_physical_pages6,
        .set_owner               = mve_buffer_attachment_set_owner6
    },
#ifndef EMULATOR
    {   /* dma buf */
        .create_buffer_external  = mve_buffer_dmabuf_create_buffer_external6,
        .destroy_buffer_external = mve_buffer_dmabuf_destroy_buffer_external6,
        .map_physical_pages      = mve_buffer_dmabuf_map_physical_pages6,
        .unmap_physical_pages    = mve_buffer_dmabuf_unmap_physical_pages6,
        .set_owner               = mve_buffer_dmabuf_set_owner6
    },
    {   /* ashmem buf */
        .create_buffer_external  = mve_buffer_ashmem_create_buffer_external6,
        .destroy_buffer_external = mve_buffer_ashmem_destroy_buffer_external6,
        .map_physical_pages      = mve_buffer_ashmem_map_physical_pages6,
        .unmap_physical_pages    = mve_buffer_ashmem_unmap_physical_pages6,
        .set_owner               = mve_buffer_ashmem_set_owner6
    }
#endif
};

bool mve_buffer_is_valid6(const struct mve_buffer_info *info)
{
    int bpp, size;
...
struct mve_buffer_external *mve_buffer_create_buffer_external6(struct mve_buffer_info *info, uint32_t port)
{
...
void mve_buffer_destroy_buffer_external6(struct mve_buffer_external *buffer)
{
    allocators[buffer->info.allocator].destroy_buffer_external(buffer);
}

bool mve_buffer_map_physical_pages6(struct mve_buffer_external *buffer)
{
    return allocators[buffer->info.allocator].map_physical_pages(buffer);
}

bool mve_buffer_unmap_physical_pages6(struct mve_buffer_external *buffer)
{
    return allocators[buffer->info.allocator].unmap_physical_pages(buffer);
}

void mve_buffer_set_owner6(struct mve_buffer_external *buffer,
                          enum mve_buffer_owner owner,
                          enum mve_port_index port)
{
