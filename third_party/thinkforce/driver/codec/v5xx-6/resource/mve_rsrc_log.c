...
struct mve_rsrc_log_group mve_rsrc_log6;
struct mve_rsrc_log_group mve_rsrc_log_scheduler6;
struct mve_rsrc_log_group mve_rsrc_log_fwif6;
struct mve_rsrc_log_group mve_rsrc_log_session6;

EXPORT_SYMBOL(mve_rsrc_log6);
EXPORT_SYMBOL(mve_rsrc_log_fwif6);
EXPORT_SYMBOL(mve_rsrc_log_session6);
...
void mve_rsrc_log_init6(void)
{
    ...
    mve_rsrc_log_group_construct(&mve_rsrc_log6, "MVE", MVE_LOG_WARNING, drain_default);
    mve_rsrc_log_group_add(&log, "generic", &mve_rsrc_log6);

    mve_rsrc_log_group_construct(&mve_rsrc_log_scheduler6, "MVE scheduler", MVE_LOG_WARNING, drain_default);
    mve_rsrc_log_group_add(&log, "scheduler", &mve_rsrc_log_scheduler6);

    mve_rsrc_log_group_construct(&mve_rsrc_log_fwif6, "MVE fwif", MVE_LOG_INFO, drain_ram);
    mve_rsrc_log_group_add(&log, "firmware_interface", &mve_rsrc_log_fwif6);

    mve_rsrc_log_group_construct(&mve_rsrc_log_session6, "MVE session", MVE_LOG_WARNING, drain_default);
    mve_rsrc_log_group_add(&log, "session", &mve_rsrc_log_session6);
}
...
void mve_rsrc_log_destroy6(void)
{
    ...
    mve_rsrc_log_group_destruct(&mve_rsrc_log6);
    mve_rsrc_log_group_destruct(&mve_rsrc_log_scheduler6);
    mve_rsrc_log_group_destruct(&mve_rsrc_log_fwif6);
    mve_rsrc_log_group_destruct(&mve_rsrc_log_session6);
...
EXPORT_SYMBOL(mve_rsrc_log_strrchr6);
EXPORT_SYMBOL(mve_rsrc_log_get_parent_dir6);
